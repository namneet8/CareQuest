...
export const Sidebar = ({ className }: Props) => {
    return (
        <div className={cn("flex h-full lg:w-[256px] lg:fixed left-0 top-0 px-4 border-r-2 flex-col z-50",
            className,
        )}>
            <Link href="/form">
            ...
            <div className="flex flex-col gap-y-2 flex-1">
                ...
                {/* AI Chatbot - External Link */}
                <div 
                    onClick={() => window.open('https://sadya-main.vercel.app/', '_blank')}
                ...
                >
                    <Image src="/chatbot.jpeg" alt="24/7 Chatbot" className="mr-5" height={32} width={32}/>
                    24/7 Chatbot
                </div>
                ...
                <div 
                    ...
                    className="inline-flex items-center justify-start gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all bg-transparent text-slate-500 border-2 border-transparent hover:bg-slate-100 transition-none h-[52px] px-4 py-2 cursor-pointer uppercase tracking-wide"
                >
                    <Image src="/appointment.jpg" alt="Book Appointment" className="mr-5" height={32} width={32}/>
                    Book Appointment
                </div>
            </div>
            <div className="p-4">
